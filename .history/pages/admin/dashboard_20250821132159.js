...
// Componente: Profesor con foto y cursos que enseña
function TeacherRowWithPhoto({ user, courses }) {
  // Cursos que este profesor enseña
  const taughtCourses = courses.filter((c) => c.teacherId === user.id);
