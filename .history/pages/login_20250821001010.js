...
export default function LoginPage() {
  ...
  return (
    <mai className="grid grid-cols-2 bg-white">
      <div className="relative bg-[url('/img/banner.jpg')] rounded-r-4xl bg-cover bg-no-repeat bg-center h-screen">
        <div className="absolute rounded-l-4xl inset-0 bg-black opacity-50"></div>
      </div>
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#673b76]  px-4">
        <div>
          {" "}
          <img src="/img/atenealogo.png" className="w-40 -mt-40 mb-40" />
        </div>
