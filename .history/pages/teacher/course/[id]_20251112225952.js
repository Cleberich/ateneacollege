          ...
          if (window.JitsiMeetExternalAPI) {
            ...
            api.addEventListeners({
              videoConferenceJoined: () => {
                console.log(
                  "Profesor unido a la conferencia",
                  currentLiveLesson.title
                );
              },
              videoConferenceLeft: () => {
                console.log(
                  "Profesor dejó la conferencia",
                  currentLiveLesson.title
                );
              },
            });
          ...
          >
            ...
            <div className="mb-4">
              ...
              >
                ...
                {/* NUEVO: Opción para clase en vivo */}
            ...
            {type === "live" && (
              <div className="mb-4 space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    El nombre de la sala donde se llevará a cabo la clase en
                    vivo.
                  </p>
                </div>
                <div>
