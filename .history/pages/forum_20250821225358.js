  ...
  useEffect(() => {
    ...
    posts.forEach((post) => {
      ...
      const unsub = onSnapshot(
        ...
        (snapshot) => {
          console.log(
            `✅ Comentarios para post ${postId}: ${snapshot.docs.length} encontrados`
          );
        ...
        (error) => {
          console.error(
            `❌ Error al escuchar comentarios del post ${postId}:`,
            error
          );
          if (error.code === "failed-precondition") {
            console.warn(
              `🚨 Necesitas crear un índice compuesto para 'postId' y 'createdAt'. ` +
    ...
    {
      /* 🔍 Depuración: Muestra estado actual */
    }
    {
      (() => {
        console.log(
        ...
        console.log("💬 Estado actual de comments:", comments);
        return null;
      })();
    }
    return () => {
