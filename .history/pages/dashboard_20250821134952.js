    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          <div className="inline-block w-8 h-8 border-4 border-atenea cursor-pointer border-t-transparent rounded-full animate-spin mb-3"></div>
                  ...
                  >
                    ...
                    <div className="p-4 mt-4 flex-1">
                      ...
                      <button
                        ...
                        className="mt-3 w-full text-center text-sm bg-atenea cursor-pointer hover:bg-blue-700 text-white py-1 rounded"
                      >
                        Entrar al Curso
                      </button>
                    </div>
              ...
              <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                {createdCourses.map((course) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-atenea cursor-pointer font-medium mt-1">
                      {course.studentCount}{" "}
