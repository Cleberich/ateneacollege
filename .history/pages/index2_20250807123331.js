    ...
    <div className="font-poppins antialiased text-gray-900">
      ...
      <header className="bg-[#51016d] shadow-sm fixed w-full top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-0 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a
              href="/plataforma/page"
              className="text-white mt-2 hover:text-primary transition font-poppins font-medium"
            >
              Plataforma
            </a>
            <a
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition">
              <h3 className="text-2xl font-bold text-primary mb-6 font-lora">
      ...
      <section id="mentors" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6 font-lora">
            Programa de Mentores
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto font-poppins">
          ...
          <div className="bg-gradient-to-br from-primary to-purple-900 text-white p-8 rounded-2xl shadow-lg max-w-4xl mx-auto">
      ...
      <section id="philosophy" className="py-20 bg-primary text-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-10 opacity-90 font-poppins">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-4xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="bg-white/10 backdrop-blur-sm p-5 rounded-lg hover:bg-white/20 transition font-poppins"
              >
      ...
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
            <h3 className="text-2xl font-semibold text-primary mb-4 font-lora">
              ¡Contáctanos!
            </h3>
            ...
            <div className="mt-8">
              <a
                href="mailto:bedelia@ateneacollege.com"
                className="bg-primary text-white font-semibold px-8 py-3 rounded-lg hover:bg-opacity-90 transition inline-block font-poppins"
              >
                Enviar correo
              </a>
            </div>
